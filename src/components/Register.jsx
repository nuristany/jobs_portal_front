...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://web-production-262c.up.railway.app/core/register/", {
        method: "POST",
        headers: {
  ...
  const verifyOtp = async (otpCode, email) => {
    try {
      ...
      const response = await fetch("https://web-production-262c.up.railway.app/core/verify-otp/", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
